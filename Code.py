...
class Graph:
    ...
    def visualize_graph(self):
        ...
        node_labels = {node: f"{node}\nCap: {G.nodes[node]['capacity']}" for node in G.nodes}
...
class JobSchedulerGUI:
    def __init__(self, master):
        ...
        self.style = Style()
        self.style.configure('TButton', font=('Trebuchet MS', 12), padding=5)
        self.style.configure('TLabel', font=('Trebuchet MS', 14))
        self.style.configure('TEntry', font=('Trebuchet MS', 12), padding=5)
